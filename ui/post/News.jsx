...
export const News = () => {
  ...
  const PostItem = memo(({ post }) => {
    ...
    return (
        <>
         <div className="relative px-4 sm:px-6 lg:px-8 dark:bg-slate-900 rounded-md shadow-slate-500">
        ...
        <AdvancedImage
          ...
          height={ 873 }
          />
      <div className="flex flex-1 flex-col justify-between dark:bg-slate-900 p-6">
            <div className="flex-1">
              ...
              <a href={post.href} className="mt-2 block">
                <p
                  className="text-xl font-semibold dark:text-tertiaryOne"
                >
                  {post.title}
                </p>
                <p className="mt-3 text-base font-serif dark:text-gray-400">
                  {post.description}
                </p>
              </a>
            </div>
  ...
  return (
      <div className="relative overflow-hidden dark:bg-slate-900 py-16">
            <ul
              role="list"
              className=""
            >
