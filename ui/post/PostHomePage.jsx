    ...
    return (
      <>
        <div className="relative">
          ...
          <div className="flex flex-1 flex-col justify-between bg-white dark:bg-slate-900 p-6">
            <div className="flex-1">
              <span className="ml-2 mt-2 inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium font-sm bg-primary w-16 h-7 font-serif text-white">
                <a href={post.category.href} className="hover:text-tertiaryOne">
                  {post.category}
                </a>
              </span>
              <a href={post.href} className="mt-2 block">
                <p
                  id="line-clamp-1"
                  className="text-lg font-semibold dark:text-tertiaryOne"
                >
                  {post.title}
                </p>
                <p id="line-clamp-1" className="mt-3 text-base dark:text-gray-400">
                  {post.description}
                </p>
              </a>
            </div>
            <div className="mt-6 flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-bse dark:text-gray-400">
                  <a href={post.author.href} className="hover:text-tertiaryOne">
                    {post.author}
                  </a>
                </p>
                <div className="flex space-x-1 text-base dark:text-gray-400;
">
                  <time className="dark:text-gray-500" dateTime={post.datetime}>{post.date}</time>
                </div>
              </div>
            </div>
          </div>
